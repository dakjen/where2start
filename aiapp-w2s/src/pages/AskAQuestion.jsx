...
export default function Chat() {
  ...
  const loadSettings = async () => {
    ...
    if (allSettings) {
      ...
      const systemPrompt = `You are a helpful AI assistant that answers questions directly and concisely.`;
      const welcomeMessage = "Hello! How can I help you today? Feel free to ask any question.";
        ...
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-300">Get quick answers to your business queries</p>
            </div>
          </div>
